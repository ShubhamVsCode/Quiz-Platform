...
/******************************************************
 * @SIGNUP
 * @route http://localhost:5050/api/auth/signup
...
/******************************************************
 * @LOGOUT
 * @route http://localhost:5050/api/auth/logout
...
/******************************************************
 * @FORGOT_PASSWORD
 * @route http://localhost:5050/api/auth/password/forgot
...
/******************************************************
 * @RESET_PASSWORD
 * @route http://localhost:5050/api/auth/password/reset/:resetToken
 ...
 * @GET_PROFILE
 * @REQUEST_TYPE GET
 * @route http://localhost:5050/api/auth/profile
